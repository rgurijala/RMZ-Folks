...
$(document).ready(function(){
	...
	var options = {
	 ...
	 $.plot($('#datausageholdersoban'), chartdata, options);
	 
	 var previousPoint = null;
	 $("#datausageholdersoban").bind("plothover", function (event, pos, item) 
	 {
...
<div id="tabs">
	...
	<div id="Babu"> Customer Name: Babu
	
	</div>
 	
	<div id="Soban" style="width:1800px;height:800px;"> Customer Name: Soban
	<div id="datausageholdersoban" style="width:50%;height:50%;"></div>
	<div id="gaugeholdersoban" style="margin-left:1200px;margin-top:-380px;width:40%;height:40%;"></div>
	</div>
