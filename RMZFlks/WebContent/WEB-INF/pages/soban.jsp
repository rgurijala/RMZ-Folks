...
<div id="tabs">
	...
	<div id="Soban" style="width:100%;height:350px;float:left;"> Customer Name: Soban
	<div id="datausageholdersoban" style="width:50%;height:100%;float:left;"></div>
	<div id="gaugeholdersoban" style="width:50%;height:350px;float:left;"></div>
	</div>
